...
/**
 * This class is wrapper exception handler. Application exceptions are captured
 * and transformed.
 * 
...
public class CustomRestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex,
		...
		return buildResponseEntity(
				new ApiError(UNSUPPORTED_MEDIA_TYPE, builder.substring(0, builder.length() - 2), ex));
	}
	...
	/**
	 * Handles EntityExistsException. Created to encapsulate errors with more
	 * detail than javax.persistence.EntityExistsException.
	 *
	 * @param ex
	...
	/**
	 * Handle javax.persistence.EntityExistsException
	 */
	@ExceptionHandler(javax.persistence.EntityExistsException.class)
	protected ResponseEntity<Object> handleEntityAlreadyExists(javax.persistence.EntityExistsException ex) {
	...
	protected ResponseEntity<Object> handleDataIntegrityViolation(DataIntegrityViolationException ex,
		...
		if (ex.getCause() instanceof ConstraintViolationException) {
			return buildResponseEntity(
					new ApiError(CONFLICT, "Database constraint violation exception", ex.getRootCause()));
		}
